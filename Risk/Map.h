...
private:
	...
	int countryinContinent; // for controlcontinent
	int numContinent; // for controlcontinent
...
private:
    ...
    std::unique_ptr<int> ownerId; //if the continent is own by a player, this is the playerId
};
